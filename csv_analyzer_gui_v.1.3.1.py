    ...
    def visualize_data(self):
        ...
        for i, column in enumerate(selected_columns):
            try:
                ...
                self.results_text.insert(tk.END, f"Warning: Column '{column}' contains non-numerical data and cannot be visualized.\n")
            except Exception as e:
                self.results_text.insert(tk.END, f"Error: Could not visualize column '{column}'. {e}\n")
